				...
				<form @submit.prevent="form.post(route('magazines.store'))">
					<div class="space-y-4">
						...
						<div class="space-y-1">
							...
							<input class="bg-white w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500" type="file" name="image_url" @change="previewImage" @input="form.image_url = $event.target.files[0]">
